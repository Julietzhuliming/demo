var courseData = {
    ...
    helpList: {
        'commonType': [
            ...
            {
                'text': MSG['c13_help_2'],
                'content': '<div><h3><span>1.</span>'+MSG['c13_help_2_1']+'</h3><img style="width:50%;margin:3rem auto;" src="course_all/13_2_1.gif" /></div><div><h3><span>2.</span>'+MSG['c13_help_2_2']+'</h3><img style="width:50%;margin:3rem auto;" src="course_all/13_2_2.gif" /></div><h3>'+MSG['c13_help_2_3']+'</h3>',
            },
            {
                'text': MSG['c13_help_3'],
                'content': '<h3><span>1.</span>'+MSG['c13_help_3_1']+'</h3><img style="width:50%;margin:3rem auto 0;" src="course_all/13_3.gif" />',
            },
        ],
    },
    toolConfig: {
