...
class courseRunner extends React.Component {
    constructor(props) {
        super(props)
        this.createSuccessPage = this.createSuccessPage.bind(this)
    ...
    componentDidMount() {
        ...
        eventsListener.on('createSuccessPage', this.createSuccessPage)
        eventsListener.on('createErrorTip', this.createErrorTip)
        eventsListener.on('goToNextMissionCallBack', this.goToNextMissionCallBack)
    ...
    componentWillUnmount() {
        ...
        eventsListener.off('createSuccessPage')
        eventsListener.off('createErrorTip')
        eventsListener.off('goToNextMissionCallBack')
    ...
    goToNextMissionCallBack(params) {
        toNextMission(params)
    }
    // 设置保存错误块的 位置信息
